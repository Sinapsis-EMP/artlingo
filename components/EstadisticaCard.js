...
import { Box, Heading, AspectRatio, Image, Text, Center, HStack, Stack, NativeBaseProvider,Avatar,VStack,Flex,Container,Spacer,Progress } from "native-base";
const EstadisticaCard = ({correctas,jugadas}) => {
  var porcentaje= Math.round((correctas / jugadas)*100);

  return(
 <Container maxWidth="full" marginHorizontal={20} style={{backgroundColor:"white", paddingTop:20, borderRadius:30 ,marginTop:20 ,marginBottom:10}}>
<Center w="100%">
      <Box w="90%" maxW="400">
        <VStack space="md">
          <VStack mx="4" space="md">
            ...
            <Progress  marginBottom={10} colorScheme="emerald" value={porcentaje} />
            {/* <Flex direction="row">
