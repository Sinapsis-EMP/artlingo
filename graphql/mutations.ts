...
export const UpdateScores = gql`
  mutation UpdateScores(
    ...
    update_scores(
      where: { jugador: { _eq: $jugador } }
      _inc: { correctas: $correctas, jugadas: $jugadas, puntos: $puntos }
    ) {
      affected_rows
    }
  }
...
export const UpdateScorez = gql`
  mutation UpdateScorez(
    ...
    update_scorez(
      _inc: { correctas: $correctas, jugadas: $jugadas, partidas: $partidas }
      _set: {
        presicion: $presicion
