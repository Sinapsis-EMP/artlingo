...
<ScrollView style={styles.container}>
      ...
      <Box w="100%"style={{backgroundColor:"#7493BA", paddingTop:20, borderRadius:30 ,marginTop:20 ,marginBottom:10}} >
               
      <VStack  space={1} alignItems="center">
        <Avatar size="2xl" bg="purple.600" alignSelf="center"  source={{
        uri: picture
      }} 
      style={{marginTop:20}}
      >
      ...
      <Text fontSize={30} color={"white"} fontWeight="bold">{name}</Text>
      <Text fontSize={18} color={"white"}>{email}</Text>

      </VStack>
      </Box>

      <Box >
      <LevelCard division={"bronce"} correctas={correctas} puntuacion={puntuacion} jugadas={jugadas} velocidad={velocidad} partidas={partidas}  ></LevelCard>
   <EstadisticaCard correctas={correctas} jugadas={jugadas} ></EstadisticaCard>
